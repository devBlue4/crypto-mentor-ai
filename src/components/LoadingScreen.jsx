    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-primary-50 flex items-center justify-center">
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        <div className="mb-12">
          ...
          <p className="text-gray-600 font-medium">Initializing CryptoMentor AI...</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-sm border border-white/20 hover:shadow-md transition-all duration-300"
        ...
        <div className="mt-12 max-w-md mx-auto">
          <div className="bg-gray-200 rounded-full h-2 overflow-hidden">
            <div className="bg-gradient-to-r from-primary-600 to-primary-800 h-2 rounded-full animate-pulse w-3/4"></div>
          </div>
